		...
		<tbody>
			<c:forEach var="user" items="${page.list}">
				<tr>
					...
					<td>${user.name}</td>
					<td>
						<form action="${linkTo[requestInfo.controller].remove(user.id)}" method="post" id="formDelete${user.id}">
							<input type="hidden" name="_method" value="delete"/>
							<div class="btn-group">
								<a href="${linkTo[requestInfo.controller].edit(user.id)}" type="button"
